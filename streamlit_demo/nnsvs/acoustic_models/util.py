...
def pad_inference(
    model, x, lengths, reduction_factor, mode="replicate", y=None, mdn=False, fluc=None
):
    ...
    if fluc is None:
        ...
        y = model(x_pad, lengths, y_pad, fluc=fluc)  # forwardへ
    ...
    if mdn:  # False
        ...
        if model.has_residual_lf0_prediction():  # True
            y = y[0]
